...
public class UmeaBirthGroomIdentity extends TwoSourcesLinkageAnalysis {
    ...
    UmeaBirthGroomIdentity(Path store_path, String repo_name, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
        super(store_path, repo_name, getLinkageResultsFilename(), getDistanceResultsFilename(), getLinkageAnalysisFilename(), number_of_records_to_be_checked, number_of_runs, false);
    }
    ...
    @Override
    public Iterable<LXP> getSourceRecords2(ConvertorImporter record_repository) {
