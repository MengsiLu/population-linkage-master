...
public abstract class TwoSourcesLinkageAnalysis extends ThresholdAnalysis {
    ...
    protected TwoSourcesLinkageAnalysis(final Path store_path, final String repo_name, final String linkage_results_filename, final String distance_results_filename, final String linkage_analysis_filename,  final int number_of_records_to_be_checked, final int number_of_runs, final boolean allow_multiple_links) throws IOException {
    ...
    protected abstract Iterable<LXP> getSourceRecords2(ConvertorImporter record_repository);
    ...
    public void setupRecords() {
        ...
        if (verbose) System.out.println("Reading records from repository: ");
