...
public class Utilities {
    ...
    public static Iterable<LXP> getBirthRecords(ConvertorImporter record_repository) {
    ...
    public static Iterable<LXP> getDeathRecords(ConvertorImporter record_repository) {
    ...
    public static Iterable<LXP> getMarriageRecords(ConvertorImporter record_repository) {
