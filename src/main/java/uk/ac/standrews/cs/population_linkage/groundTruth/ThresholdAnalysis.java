...
import uk.ac.standrews.cs.population_linkage.supportClasses.RecordList;
...
//    final String repo_name;
    ...
    private PrintWriter linkage_analysis_writer;
    ...
    public List<LXP> source_records;
    ...
    ThresholdAnalysis(final String linkage_results_filename, final String distance_results_filename, final String linakge_analysis_filename, final int number_of_records_to_be_checked, final int number_of_runs, final boolean allow_multiple_links) throws IOException {

        System.out.println("Running ground truth analysis for " + getLinkageType() + " on data: ");
...
//        this.repo_name = repo_name;
        ...
        linkage_analysis_writer = new PrintWriter(new BufferedWriter(new FileWriter(linakge_analysis_filename+ ".csv", false)));
    ...
    protected static String getLinkageAnalysisFilename() {

        return getCallingClassName() + "LinkageAnalysis";
    }
    ...
    public abstract Iterable<LXP> getSourceRecords(ConvertorImporter record_repository);

    public abstract void setupRecords() throws IOException;
...
//        printMetaData();
        ...
        //final long number_of_blocks_to_be_checked = 10 / BLOCK_SIZE;
    ...
    protected void processRecord(final int record_index, final int last_record_index, final List<LXP> records1, final List<LXP> records2, final Metric<LXP> metric, final boolean increment_counts) {
...
//                    }
                ...
                UmeaBirthSiblingSpringBoot.LinkageAnalysis.add(new LinkageList(record1_id, record2_id, distance, link_status, metric_name));

//                Set<LinkageList> linkageSet = new HashSet<>(LinkageAnalysis);
//                List<LinkageList> list = new ArrayList<>(linkageSet);
//                String FilterPairDistance= new Gson().toJson(list);
//
...
//                for (LinkageList t: LinkageAnalysis) {
//                    System.out.println(t);
//                    }
...
//    private void LinkageAnalysisJson(Object record1_id, Object record2_id, double distance, LinkStatus link_status, String metric_name){
//        List<LinkageList> LinkageAnalysis = new ArrayList<>();
//        LinkageAnalysis.add(new LinkageList(record1_id, record2_id, distance, link_status, metric_name));
//
////        for (LinkageList t: LinkageAnalysis) {
////            System.out.println(t);
////        }
//        String json = new Gson().toJson(LinkageAnalysis);
...
//    }
    ...
    private void printHeaders() {
        ...
        linkage_analysis_writer.print("time");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print("record1_id");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print("record2_id");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print("distance");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print("true link");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print("metric_name");
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.println();
        linkage_analysis_writer.flush();
    ...
    private void printLinkageAnalysis(Object record1, Object record2, double distance, String metric_name){

        linkage_analysis_writer.print(LocalDateTime.now());
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print(record1);
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print(record2);
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print(distance);
        linkage_analysis_writer.print(DELIMIT);
        linkage_analysis_writer.print(metric_name);
